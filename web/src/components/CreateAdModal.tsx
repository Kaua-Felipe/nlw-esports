        ...
        <Dialog.Portal>
          ...
          <Dialog.Content className="fixed bg-[#2A2634] py-8 px-10 text-white top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 rounded-lg w-[480px] shadow-lg shadow-black/25">
            ...
            <form onSubmit={handleCreateAd} className="mt-8 flex flex-col gap-4">
              ...
              <label className="mt-2 flex gap-2 text-sm items-end">
                <CheckBox.Root 
              ...
              <footer className="mt-4 flex justify-end gap-4">
                <Dialog.Close className="bg-zinc-500 px-5 h-12 rounded-md font-semibold hover:bg-zinc-600 duration-500">Cancelar</Dialog.Close>
                <button type="submit" className="bg-violet-500 px-5 h-12 rounded-md font-semibold flex items-center gap-3 hover:bg-violet-600 duration-500">
